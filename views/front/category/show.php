                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php if(!empty($package->image)): ?>
                                    <div class="product-img border border-secondary" style="background-image: url('<?php echo url('/assets/images/'.$package->image); ?>');">
                                    </div>
                                <?php else: ?>
                                    <div class="product-img border border-secondary" style="background-image: url('<?php echo url('/assets/images/no.jpeg'); ?>');">
                                    </div>
                                <?php endif; ?>
                            </div>
