            ...
            <div class="col-6 mx-auto">
                <form action="<?php echo url('/packages/update/'.$package->id); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="name" class="form-control" rows="2" required> <?php echo $package->description; ?></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="district_id" id="district_id" class="form-control" required>
                            <?php foreach ($districts as $district): ?>
                                <option value="<?php echo $district->id; ?>" <?php echo $district->id == $package->district_id ? 'selected': ''; ?>><?php echo $district->name; ?> </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="category_id" id="category_id" class="form-control" required>
                            <?php foreach ($categories as $category): ?>
                                <option value="<?php echo $category->id; ?>" <?php echo $category->id == $package->category_id ? 'selected': ''; ?>><?php echo $category->name; ?> </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="address">Address</label>
                        <textarea name="address" id="address" rows="2" class="form-control"  required><?php echo $package->address; ?></textarea>
                    </div>
                    <div class="form-group">
